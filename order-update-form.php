...
<tr id="order-update-form">
    ...
    <td class="td-price_bank">
        <div class="bank-logo <?=$arrayData['price_bank']=='tinkoff'? 'checked' : ''?>">
            <label><img src="assets/img/icons/bank/tinkoff.png" alt="tinkoff"><input type="radio" name="price_bank" value="tinkoff" <?=$arrayData['price_bank']=='tinkoff'? 'checked="checked"' : ''?>></label><br />
        </div>
        <div class="bank-logo <?=$arrayData['price_bank']=='rncb'? 'checked' : ''?>">
            <label><img src="assets/img/icons/bank/rncb.jpg" alt="rncb"><input type="radio" name="price_bank" value="rncb" <?=$arrayData['price_bank']=='rncb'? 'checked="checked"' : ''?>></label><br />
        </div>
        <div class="bank-logo <?=$arrayData['price_bank']=='sberbank'? 'checked' : ''?>">
            <label><img src="assets/img/icons/bank/sberbank.png" alt="sberbank"><input type="radio" name="price_bank" value="sberbank" <?=$arrayData['price_bank']=='sberbank'? 'checked="checked"' : ''?>></label>
        </div>
    </td>
    ...
    <td class="td-price_delivery">
        <input id="price_delivery" type="number" value="<?=htmlentities($arrayData['price_delivery'])?>" <?=$arrayData['bus_delivery'] ? 'disabled' : ''?>><br /><br />
